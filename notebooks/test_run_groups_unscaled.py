...
def main(class_count):
    ...
    model.evaluate(model, class_count, class_type.Group, 5, "Raw Yolo ", train_type.default,gen_confusion_matrix=True)
    ...
    model.evaluate(model, class_count=class_count, class_type=class_type.Group, k_fold_value=5, name="Distilled Model - Unscaled",
